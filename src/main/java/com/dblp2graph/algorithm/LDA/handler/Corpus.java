...
public class Corpus {
	...
	static Map<Integer, String> indexDocumentMaps;

	public Corpus() {
		documentList = new LinkedList<int[]>();
		vocabulary = new Vocabulary();
		indexDocumentMaps = new HashMap<>();
	}
	...
	public static Map<Integer, String> getIndexDocumentMaps() {
		return indexDocumentMaps;
	}

	public static void setIndexDocumentMaps(Map<Integer, String> indexDocumentMaps) {
		Corpus.indexDocumentMaps = indexDocumentMaps;
	}
	...
	public static Corpus load(String folderPath) throws IOException {
		...
		for (File file : folder.listFiles()) {
			...
			br.close();
			indexDocumentMaps.put(index, file.getName());
